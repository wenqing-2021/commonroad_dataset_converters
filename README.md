...
* **keep_ego**: Boolian flag to keep vehicles used for planning problems in the scenario. 
This is an optional flag. The default is *False*.
* **obstacle_start_at_zero**: Boolian flag to require whether the initial state of an obstacle has to start at time step zero. This is an optional flag, default is *False*. 
...
additonal parameters for the highD Dataset onlu:

...
def validate(xml_path: Path, xsd_path: Path) -> 0:
    ...
    try:
        ...
        xmlschema.assertValid(etree.parse(str(xml_path)))
...
def main():
    ...
    parser.add_argument("-s", help="Path to schema file (.xsd commonroad specification)", default="./XML_commonRoad_XSD_2020a.xsd", dest="spec")

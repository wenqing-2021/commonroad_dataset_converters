...
from src.rounD.map_utils import load_lanelet_networks, meta_scenario_from_recording
from src.rounD.obstacle_utils import generate_obstacle
...
def generate_scenarios_for_record(recording_meta_fn: str, tracks_meta_fn: str, tracks_fn: str,
    ...
    for idx_1 in range(num_scenarios):
        ...
        try:
            generate_single_scenario(round_config, num_planning_problems, keep_ego, output_dir, tracks_df,
